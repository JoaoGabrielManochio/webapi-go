...
type User struct {
	...
	CreatedAt time.Time      `gorm:"column:created_at;type:datetime;not null" json:"created"`
	UpdatedAt time.Time      `gorm:"column:updated_at;type:datetime;not null" json:"updated"`
	DeletedAt gorm.DeletedAt `gorm:"column:deleted_at;type:datetime;not null" json:"deleted"`
}
